...
function keyPressed(){
	...
	//if(keyCode == 83) player.setSpeed(5, 0);// Sキーを押した時
	//if(keyCode == 65) player.setSpeed(5, 0);// Aキーを押した時
	// Wキーを押した時
...
function createMarisa(mil){
	...
	if(!enemyGroup){
		...
		enemy.setSpeed(random(2, 2), random(360));// ポイント6-1
		enemy.scale = random(1, 1);// ポイント6-2
		enemy.debug = true;
