...
/***/ (function(module, exports, __webpack_require__) {
	...
	AFRAME.registerComponent('teleport-controls', {
	  schema: {
	    ...
	    landingNormal: {type: 'vec3', default: { x: 0, y: 1, z: 0 }},// 20211212
	...
	function createDefaultPlane (size) {
	  ...
	  geometry = new THREE.PlaneBufferGeometry(size, size);// 20211212
...
/***/ (function(module, exports) {
	...
	var RayCurve = function (numPoints, width) {
	  ...
	  this.geometry.setAttribute('position', new THREE.BufferAttribute(this.vertices, 3).setUsage(true));// 20211212
	  ...
	  //this.mesh.drawMode = THREE.TriangleStripDrawMode;// 20211212
