;メッセージレイヤの定義
		...
		[position width=600 height=158 top=278 left=20 ]
		...
		[ptext name="chara_name_area" layer="message0" color=0xFFFFFF size=26 x=30 y=288 bold="bold" edge="" shadow=""]
		...
		[position layer="message1" width=600 height=158 top=278 left=20 ]
